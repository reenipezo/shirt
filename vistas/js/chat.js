var sendForm = document.querySelector('#chatform'),
    ...
    previousInput,
    isReaction = false,
    unkwnCommReaction = "No entendí eso.",
...
var possibleInput = {
  ...
  "contacto" : function(){
    responseText("Contáctenos: <a href='vistas/contact.html' target='_top'>Haz Click Aquí</a>");
    responseText("Llámenos: <a href='tel: +51 944028451'>+51 944 028 451</a>");
    commandReset(7);
    return
  },
  "commands" : function(){
